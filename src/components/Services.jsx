    ...
    <div className='container'>
        ...
        <div className='relative'>
            ...
            <div className='absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto'>
                <img
                className='w-ful h-full object-cover md:object-right'
                width={800}
                height={730}
                src={service1}
                alt="Smartest AI" />
            ...
            <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                ...
                <p className='body-2 mb-[3rem] text-n-3 '>Automatically enhance your photos using our AI app&apos;s photos editing feature. Try it now!
                </p>
                </div>
                <PhotoChatMessage/>
                </div>
                <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                    ...
                    <div className='relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]'>
                        <img src={service3} className='w-full h-full object-cover' width={520} height={400} alt="Another robot" />
                        <VideoChatMessage/>
                        <VideoBar/>
                    </div>
                </div>
